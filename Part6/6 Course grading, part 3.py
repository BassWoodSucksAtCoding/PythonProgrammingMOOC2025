...
for key, values in names.items():
    print(f"{names[key]:30}{total_exercises[key]:<10}{int(overall_total_points[key]-total_exam_points[key]):<10}{total_exam_points[key]:<10}{int(overall_total_points[key]):<10}{grade[key]:<10}")
